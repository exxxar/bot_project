...
'
        ...
        [
            ...
            "title" => "Курс \"New York\"",
            "price" => 3000,
            "images" => ["https://sun9-43.userapi.com/-kOhkRP6kCUAXHLJUl-WImAZUs86rbaXQ1pM7g/jpRQ9xOuRME.jpg"],
...
9. Фотопозирование – профессиональная модельная сьемка проходит на разную тематику в разных локациях, в разных образах. Для модели будет создано портфолио которое поможет ей показать широкий спектр способностей и раскрыть как можно больше ее выгодных сторон.
        ...
        [
            ...
            "title" => "Курс \"Milan\"",
            "price" => 3000,
            "images" => ["https://sun9-29.userapi.com/jMUUNXDuAXGPEE_tEa0ByfIMKEouYnJJna74mA/UeVCUJPJSNM.jpg"],
            "description" => '1. Искусство дефиле – один из основных предметов модельной школы. Главное в дефиле – особая техника движения на подиуме или сцене. Модель изучает различные стили дефиле, модельные постановки, точки поворота, разнообразные техники движения в разной одежде: вечерних нарядах, белье, верхней одежде, учатся в совершенстве владеть своим телом.
...
11. Рисование – в основе занятий лежит наблюдение и изучение окружающей действительности, формирование у детей целостного, живого представления о предметах и явлениях.
        ...
        [
            ...
            "title" => "Курс \"Monaco\"",
            "price" => 3000,
            "images" => ["https://sun9-73.userapi.com/Asxs_j6i6AR_hI5nXBguae0aO0w2YcURZuKjCQ/bGDXhrk5V4k.jpg"],
            "description" => '1. Искусство дефиле – один из основных предметов модельной школы. Главное в дефиле – особая техника движения на подиуме или сцене. Модель изучает различные стили дефиле, модельные постановки, точки поворота, разнообразные техники движения в разной одежде: вечерних нарядах, белье, верхней одежде, учатся в совершенстве владеть своим телом.
...
11. Рисование – в основе занятий лежит наблюдение и изучение окружающей действительности, формирование у детей целостного, живого представления о предметах и явлениях.
        ...
        [
            ...
            "title" => "Курс \"Venice\"",
            "price" => 3500,
            "images" => ["https://sun9-34.userapi.com/6Fuve2uTx-zmWYUKJY-P_y1EyCJVkh_maIrqsg/GsZzVtoLK2E.jpg"],
...
11. Рисование (2) – в основе занятий лежит наблюдение и изучение окружающей действительности, формирование у детей целостного, живого представления о предметах и явлениях.
        ...
        [
            ...
            "price" => 3500,
            "images" => ["https://sun9-47.userapi.com/9mHek3UtZs2sj2nvAKuL48I53tzW0aVlxJnjfg/UqQInwCmD8g.jpg"],
...
9. Фотопозирование(3) – профессиональная модельная сьемка проходит на разную тематику в разных локациях, в разных образах. Для модели будет создано портфолио которое поможет ей показать широкий спектр способностей и раскрыть как можно больше ее выгодных сторон
        ...
        [
            ...
            "title" => "Курс \"Florence\"",
            "price" => 3000,
            "images" => ["https://sun9-75.userapi.com/6y0JQrpVkOSNlycf191p7Vz82zQUbSRwHlkG5Q/606c5CmgkD8.jpg"],
            "description" => 'Florence - углубленный курс для моделей, которые прошли базовый курс обучения для мальчиков и девочек от 4 до 7 лет

Курс длится 12 месяцев

Занятия проходят по выходным дням с 10:00-12:00
Стоимость обучения 3000 руб./мес. + бесплатное участие в 1-ой фотосессии.

Занятия проходят блоками, после окончания блока открытое занятие для родителей или презентация своего проекта.

Дисциплины:
1. Модельная пластика
2. Мастерская эмоция
3. Art kids
4. Вокал
5. Нейрогимнастика
...
7. Хореография
        ...
        [
            'type' => ProductTypeEnum::LKCCourses,
            "title" => "Курс \"Hollywood\"",
            "price" => 3000,
            "images" => ["https://sun9-74.userapi.com/NjTAO-zo9Niuw3tHJcMHFDRpvxjCHVdsCGw5Ww/2ahcJkUNWa8.jpg"],
            "description" => 'Курс Hollywood - углубленный курс для моделей, которые прошли базовый курс обучения (от 8 до 14 лет)
Занятия проходят по выходным дням с 12:00 - 14:00

Обучение длится 12 месяцев
Стоимость обучения 3000 руб./мес. + бесплатное участие в 1-ой фотопроекте
